...
export default function Contact({ settings }: ContactProps) {
  ...
  const contactEmail = settings?.contactEmail || 'hello@gutshell.com';
    ...
    <section id="contact" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
          ...
          {/* Left — Form Card */}
          <div className="bg-amber-300 rounded-[2rem] p-8 sm:p-10">
            {status === 'sent' ? (
              ...
              <>
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 font-serif mb-2">Get In Touch</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="px-8 py-3.5 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-600 text-white font-bold rounded-full transition-colors text-sm"
                    >
          ...
          <div className="flex flex-col gap-6">
            {/* Contact Info */}
            <div className="bg-gray-50 rounded-[2rem] p-8 sm:p-10 flex-1">
              <p className="text-primary-600 font-semibold text-sm uppercase tracking-wide mb-2">Contact Info</p>
              <h3 className="text-2xl font-bold text-gray-900 font-serif mb-6">We&apos;d love to hear from you</h3>
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={info.label} className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-xl flex-shrink-0 shadow-sm">
                      {info.icon}
                    </div>
                    <div>
            ...
            {/* WhatsApp CTA */}
            <div className="bg-primary-600 rounded-[2rem] p-8 sm:p-10 text-white">
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center text-2xl flex-shrink-0">
                  💬
                </div>
                <div>
                  <h4 className="font-bold text-lg">Not sure where to start?</h4>
                  <p className="text-primary-100 text-sm mt-1 leading-relaxed">
                    Book a free 10-minute discovery call. No commitment, no pressure — just guidance.
                  </p>
                </div>
              </div>
              <a
                ...
                className="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-white text-primary-700 rounded-full font-bold text-sm hover:bg-primary-50 transition-colors"
              >
