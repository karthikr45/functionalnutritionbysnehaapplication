        ...
        <div className="bg-olive-gradient py-12 sm:py-16 text-white text-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-6 px-8 py-3.5 bg-cream text-warm-footer rounded-full font-bold text-sm hover:bg-cream-dark transition-colors"
            >
