...
const socialItems = [
  { name: 'Instagram', icon: <InstagramIcon />, key: 'instagramUrl' },
  { name: 'YouTube', icon: <YouTubeIcon />, key: 'youtubeUrl' },
  { name: 'LinkedIn', icon: <LinkedInIcon />, key: 'linkedinUrl' },
...
export default function Footer({ settings: propSettings }: FooterProps) {
  ...
  return (
    <footer className="bg-olive-gradient text-warm-footer-text" style={{ color: '#D8D5BC' }}>
