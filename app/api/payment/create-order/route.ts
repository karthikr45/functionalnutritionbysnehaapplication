...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (type === 'appointment' && appointmentId) {
      ...
      // Login is enforced by the role check above; no further profile
      // requirements at purchase time. Doctor collects DOB / address /
      // medical history during the first consultation.
      amount = pkg.price;
