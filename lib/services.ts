...
export const SERVICE_OPTIONS: ServiceMeta[] = [
  ...
  { value: 'metabolic-health-program', label: 'Metabolic Health Program', emoji: '🩺', tagline: 'For PMOS, diabetes, thyroid & cardiac care.', accentBg: 'bg-rose-100', accentText: 'text-rose-700' },
